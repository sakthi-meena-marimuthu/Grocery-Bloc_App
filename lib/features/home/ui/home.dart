  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HomeBloc, HomeState>(
      ...
      listener: (context, state) {
        ...
        else if (state is HomeProductCartListedState) {
          ScaffoldMessenger.of(context)
              .showSnackBar(const SnackBar(content: Text('Product added to the cart')));
        } else if (state is HomeProductWishListedState) {
          ScaffoldMessenger.of(context)
              .showSnackBar(const SnackBar(content: Text('Product added to the wishlist')));
        }
      },
